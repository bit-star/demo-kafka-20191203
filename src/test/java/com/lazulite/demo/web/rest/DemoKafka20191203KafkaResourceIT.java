...
public class DemoKafka20191203KafkaResourceIT {
    ...
    @Autowired
    private DemoKafka20191203KafkaProducer producer;

    @Autowired
    private DemoKafka20191203KafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DemoKafka20191203KafkaResource kafkaResource = new DemoKafka20191203KafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/demo-kafka-20191203-kafka/publish?message=test"))
